!function(){"use strict";try{if("undefined"!=typeof document){var o=document.createElement("style");o.appendChild(document.createTextNode('kirby-loop{--color-base:var(--color-neutral-900);--color-base-background:var(--color-neutral-0);--color-base-background-o:oklch(1 var(--color-neutral-c)var(--color-neutral-h)/.95);--color-accent-h:900;--color-accent-c:.18;--color-accent-l:.75;--color-accent-dark-factor:.4;--color-accent-light-factor:1.2;--color-neutral-h:900;--color-neutral-c:0;--color-accent-light:oklch(calc(var(--color-accent-l)*var(--color-accent-light-factor))var(--color-accent-c)var(--color-accent-h));--color-accent:oklch(var(--color-accent-l)var(--color-accent-c)var(--color-accent-h));--color-accent-dark:oklch(calc(var(--color-accent-l)*var(--color-accent-dark-factor))var(--color-accent-c)var(--color-accent-h));--color-neutral-0:oklch(1 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-100:oklch(.95 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-200:oklch(.9 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-300:oklch(.7 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-400:oklch(.6 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-1000:oklch(0 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-600:oklch(.4 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-700:oklch(.3 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-800:oklch(.2 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-900:oklch(.1 var(--color-neutral-c)var(--color-neutral-h));--color-success:oklch(.65 .15 150);--color-warning:oklch(.75 .15 80);--color-error:oklch(.65 .18 25);--color-info:oklch(.65 .15 220);--font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol",sans-serif;--line-height:1.4;--font-weight-light:300;--font-weight-normal:400;--font-weight-medium:550;--font-weight-bold:700;--font-size-3:clamp(1.9531rem,1.4262rem + 1.7565vw,3.5339rem);--font-size-4:clamp(1.5625rem,1.2503rem + 1.0408vw,2.4992rem);--font-size-5:clamp(1.25rem,1.0775rem + .575vw,1.7675rem);--font-size-6:clamp(1rem,.9167rem + .2778vw,1.25rem);--font-size-7:clamp(.8rem,.772rem + .0934vw,.884rem);--font-size-8:clamp(.6252rem,.6449rem + -.0165vw,.64rem);--border-radius-s:.125rem;--border-radius:.25rem;--border-radius-rounded:4096px;--space-2xs:clamp(.25rem,.2292rem + .0694vw,.3125rem);--space-xs:clamp(.5rem,.4583rem + .1389vw,.625rem);--space-s:clamp(1rem,.9167rem + .2778vw,1.25rem);--space-m:clamp(1.5rem,1.375rem + .4167vw,1.875rem);--space-l:clamp(2rem,1.8333rem + .5556vw,2.5rem);--space-2xs-xs:clamp(.25rem,.125rem + .4167vw,.625rem);--space-xs-s:clamp(.5rem,.25rem + .8333vw,1.25rem);--space-s-m:clamp(1rem,.7083rem + .9722vw,1.875rem);--space-m-l:clamp(1.5rem,1.1667rem + 1.1111vw,2.5rem);--space-s-l:clamp(1rem,.5rem + 1.6667vw,2.5rem);--loop-dialog-background:transparent;--shadow-xs:0 .1em .25em #0000001a;--shadow-s:0 0rem 2rem #0003;--shadow-m:0 10px 30px #0003;--shadow-l:0 20px 40px #00000040;--backdrop-overlay:#00000080;--backdrop-blur:blur(4px);--backdrop-panel:blur(10px);--transition-fast:.2s ease;--transition-medium:.3s ease;--transition-slow:.4s ease;--transition-transform:transform .2s ease;--opacity-subtle:.5;--opacity-medium:.7;--opacity-strong:.9;--outline-color:var(--color-accent);--outline-offset:.25rem;--z-loop-marker:9998;--z-loop-panel:9999;--z-loop-dialog:10000;--loop-glass-effect-background:var(--color-base-background-o);--loop-glass-effect-backdrop:var(--backdrop-panel);--loop-marker-size:2rem;--loop-marker-background:var(--color-accent);--loop-marker-color:var(--color-accent-dark);--loop-avatar-size:2.5rem;--loop-panel-width:380px;--loop-button-height:2.25rem;--loop-button-header-height:3rem;--loop-textarea-height:15ch;--loop-textarea-font-size:var(--font-size-7);--loop-textarea-font-size-large:var(--font-size-6);--loop-comment-dialog-max-width:300px;--loop-welcome-dialog-max-width:500px}@media (prefers-color-scheme:dark){kirby-loop{--color-base-background-o:oklch(.1 var(--color-neutral-c)var(--color-neutral-h)/.6);--color-neutral-100:oklch(.2 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-200:oklch(.25 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-300:oklch(.3 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-1000:oklch(.5 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-600:oklch(.6 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-700:oklch(.7 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-800:oklch(.8 var(--color-neutral-c)var(--color-neutral-h));--color-neutral-900:oklch(.85 var(--color-neutral-c)var(--color-neutral-h))}}kirby-loop{font-family:var(--font-family);line-height:var(--line-height);font-weight:var(--font-weight-normal);font-size:var(--font-size-7);box-sizing:border-box}html.loop-overlay-open a{pointer-events:none}')),document.head.appendChild(o)}}catch(r){console.error("vite-plugin-css-injected-by-js",r)}}();
...
var root$f = /* @__PURE__ */ ns_template(`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-267e7"><path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="currentColor" stroke-width="1.5"></path><path d="M15 12H12M12 12H9M12 12V9M12 12V15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path></svg>`);
const $$css$g = {
  hash: "svelte-267e7",
  code: "svg.svelte-267e7{width:var(--size,1em);height:var(--size,1em)}"
};
...
var root_1$2 = /* @__PURE__ */ template(`<span class="svelte-1ofb3jj"><!></span>`);
var root$e = /* @__PURE__ */ template(`<button><!> <!></button>`);
const $$css$f = {
  hash: "svelte-1ofb3jj",
  code: "button.svelte-1ofb3jj{--button-background:transparent;--button-color:var(--color-neutral-600);--button-height:var(--loop-button-height);appearance:none;background-color:var(--button-background);color:var(--button-color);padding:0 var(--space-xs);font-family:var(--font-family);letter-spacing:.01em;border-radius:var(--border-radius);gap:var(--space-2xs);cursor:pointer;font-size:var(--font-size-7);font-weight:var(--font-weight-medium);transition:all var(--transition-fast);white-space:nowrap;height:var(--button-height);outline-color:var(--outline-color);border:0;flex:none;justify-content:center;align-items:center;line-height:1;display:inline-flex}button.svelte-1ofb3jj:focus-visible{outline-offset:var(--outline-offset)}button.svelte-1ofb3jj:hover,button.svelte-1ofb3jj:focus-visible{--button-color:var(--color-neutral-900);--button-background:var(--color-neutral-200)}button.svelte-1ofb3jj span:where(.svelte-1ofb3jj){text-overflow:ellipsis;min-width:0;display:block;overflow-x:clip}button.button--header.svelte-1ofb3jj{--button-background:transparent;--button-height:var(--loop-button-header-height);padding:0 var(--space-s);border:0;border-radius:0}button.button--header.svelte-1ofb3jj:hover,button.button--header.svelte-1ofb3jj:focus-visible{--button-background:var(--color-base-background-o)}button.button--panel.svelte-1ofb3jj{--button-background:transparent;--button-height:auto;padding:0 calc(var(--space-s)*.4);border:0;border-radius:0}button.button--panel.svelte-1ofb3jj span:where(.svelte-1ofb3jj){overflow:visible}button.button--solid.svelte-1ofb3jj{--button-background:var(--color-neutral-100)}button.button--solid.svelte-1ofb3jj:hover,button.button--solid.svelte-1ofb3jj:focus-visible{--button-color:var(--color-neutral-900);--button-background:var(--color-neutral-200)}button.button--small.svelte-1ofb3jj{--button-height:1.5rem;font-size:var(--font-size-7)}button.button--icon.svelte-1ofb3jj{--button-background:var(--color-neutral-0);--button-color:var(--color-neutral-900);--button-height:3rem;box-shadow:var(--shadow-s);aspect-ratio:1;font-size:var(--font-size-6);border-radius:var(--border-radius-rounded);border:0;padding:0}button.button--icon.svelte-1ofb3jj:hover,button.button--icon.svelte-1ofb3jj:focus-visible{--button-background:var(--color-neutral-100);--button-color:var(--color-neutral-900)}button.button--marker.svelte-1ofb3jj{--button-background:var(--loop-marker-background);--button-color:var(--loop-marker-color);height:var(--marker-size);width:var(--marker-size);font-weight:var(--font-weight-bold);border-radius:var(--border-radius-rounded);border:0;padding:0}button.button--marker.svelte-1ofb3jj :where(.svelte-1ofb3jj){pointer-events:none}button.button--marker.button--marker-highlighted.svelte-1ofb3jj{--button-background:var(--color-accent);--button-color:var(--color-accent-dark)}button.button--marker-open.svelte-1ofb3jj{--button-background:var(--color-accent);--button-color:var(--color-accent-dark)}button.button--filter.svelte-1ofb3jj{--button-background:transparent;--button-color:var(--color-neutral-500);--button-height:1.75rem;font-size:var(--font-size-8);padding:0 var(--space-xs);border-radius:calc(var(--border-radius) - 2px);flex:1}button.button--filter.svelte-1ofb3jj:hover,button.button--filter.svelte-1ofb3jj:focus-visible{--button-color:var(--color-neutral-700);--button-background:var(--color-neutral-200)}button.button--filter.button--filter-active.svelte-1ofb3jj{--button-background:var(--color-base-background);--button-color:var(--color-base);font-weight:var(--font-weight-medium)}button.button--filter.button--filter-active.svelte-1ofb3jj:hover,button.button--filter.button--filter-active.svelte-1ofb3jj:focus-visible{--button-background:var(--color-base-background);--button-color:var(--color-base)}button.button--menu-item.svelte-1ofb3jj{--button-background:transparent;--button-color:var(--color-neutral-700);width:100%;padding:var(--space-2xs)var(--space-xs);border-radius:calc(var(--border-radius) - 2px);font-size:var(--font-size-7);justify-content:flex-start;gap:var(--space-2xs)}button.button--menu-item.svelte-1ofb3jj:hover,button.button--menu-item.svelte-1ofb3jj:focus-visible{--button-background:var(--color-neutral-100);--button-color:var(--color-neutral-900)}button.button--menu-item.button--menu-item-active.svelte-1ofb3jj{--button-background:var(--color-accent-light);--button-color:var(--color-accent-dark);font-weight:var(--font-weight-medium)}button.button--menu-item.button--menu-item-active.svelte-1ofb3jj:hover,button.button--menu-item.button--menu-item-active.svelte-1ofb3jj:focus-visible{--button-background:var(--color-accent-light);--button-color:var(--color-accent-dark)}button.is-active.svelte-1ofb3jj{--button-background:var(--color-accent);--button-color:var(--color-accent-dark)}button.is-active.svelte-1ofb3jj:hover{--button-color:var(--color-accent-dark);--button-background:var(--color-accent)}button.svelte-1ofb3jj:disabled{opacity:var(--opacity-subtle);cursor:not-allowed}button.svelte-1ofb3jj:disabled:hover{--button-color:var(--color-neutral-700);--button-background:var(--color-neutral-100)}"
};
function Button($$anchor, $$props) {
  ...
  template_effect(
    ($0) => {
      classes = set_class(button, 1, `button ${style() ?? ""}`, "svelte-1ofb3jj", classes, $0);
...
var root_5$2 = /* @__PURE__ */ template(`<span class="count glass-effect-small svelte-t50am9"> </span>`);
var root$c = /* @__PURE__ */ template(`<header><div class="toggle svelte-t50am9"><!> <!></div> <!></header>`);
const $$css$d = {
  hash: "svelte-t50am9",
  code: ".toggle.svelte-t50am9{display:flex}header.svelte-t50am9{top:var(--space-xs);max-width:100%;color:var(--color-base);border-radius:var(--border-radius-rounded);z-index:9999;justify-content:space-between;align-items:stretch;display:flex;position:fixed;left:50%;transform:translate(-50%)}header.bottom.svelte-t50am9{top:auto;bottom:var(--space-xs)}.count.svelte-t50am9{border-radius:var(--border-radius-rounded);justify-content:center;align-items:center;width:2rem;height:2rem;display:flex}"
};
function Header($$anchor, $$props) {
  ...
  reset$1(header);
  template_effect(($0) => classes = set_class(header, 1, "glass-effect svelte-t50am9", null, classes, $0), [
...
const $$css$c = {
  hash: "svelte-hvqm96",
  code: ".marker.svelte-hvqm96{--marker-size:var(--loop-marker-size);z-index:var(--z-loop-marker);border-radius:var(--border-radius-rounded);position:absolute;transform:translate(-50%,-50%)}.marker--pulse.svelte-hvqm96{animation:1s ease-in-out svelte-hvqm96-pulse}@keyframes svelte-hvqm96-pulse{0%{box-shadow:0 0 0 0 var(--color-accent),0 0 0 0 #8080804d,0 0 0 0 #80808033}30%{box-shadow:0 0 0 8px #0000,0 0 #8080804d,0 0 #80808033}60%{box-shadow:0 0 0 12px #0000,0 0 0 8px #80808026,0 0 #80808033}to{box-shadow:0 0 0 16px #0000,0 0 0 12px #0000,0 0 0 8px #0000}}"
};
function Marker($$anchor, $$props) {
  ...
  user_effect(() => {
    if (panel.pulseMarkerId === comment$1().id) {
      set(shouldPulse, true);
      setTimeout(
        () => {
          set(shouldPulse, false);
        },
        1e3
      );
    }
  ...
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      ...
      template_effect(
        ($0) => {
          classes = set_class(div, 1, `marker marker--${comment$1().status ?? ""}`, "svelte-hvqm96", classes, $0);
...
var root$b = /* @__PURE__ */ template(`<form method="POST" class="svelte-xqnmxb"><div class="input"><textarea name="comment" required class="svelte-xqnmxb"></textarea></div> <div class="keyboard-hint svelte-xqnmxb"> </div> <footer class="svelte-xqnmxb"><!> <!></footer></form>`);
const $$css$b = {
  hash: "svelte-xqnmxb",
  code: "form.svelte-xqnmxb{cursor:auto;background-color:var(--color-base-background);color:var(--color-base);border-radius:var(--border-radius);border:1px solid var(--color-neutral-200);padding:0;overflow:hidden}textarea.svelte-xqnmxb{width:100%;height:var(--loop-textarea-height);resize:none;padding:var(--space-s);box-sizing:border-box;background-color:var(--color-base-background);font-family:var(--font-family);font-size:var(--loop-textarea-font-size);color:currentColor;border:0;margin:0}textarea.svelte-xqnmxb:focus-visible,textarea.svelte-xqnmxb:focus{outline:0}footer.svelte-xqnmxb{padding:var(--space-xs);gap:var(--space-xs);display:flex}footer.svelte-xqnmxb button{flex:1}.keyboard-hint.svelte-xqnmxb{font-size:var(--font-size-8);color:var(--color-neutral-300);padding:0 var(--space-xs)var(--space-xs)var(--space-xs);white-space:nowrap;align-self:center;margin-left:auto}"
};
...
var root$a = /* @__PURE__ */ template(`<div class="author svelte-f1nv8x"> </div>`);
const $$css$a = {
  hash: "svelte-f1nv8x",
  code: ".author.svelte-f1nv8x{font-size:var(--font-size-6);text-transform:uppercase;color:var(--color-neutral-600);background-color:var(--color-neutral-100);aspect-ratio:1;flex:0 0 var(--_avatar-size);border-radius:var(--border-radius-rounded);justify-content:center;align-items:center;display:flex}"
};
...
var root$9 = /* @__PURE__ */ template(`<div class="reply svelte-1xkpg8l"><!> <article class="reply__content svelte-1xkpg8l"><header class="svelte-1xkpg8l"><strong> </strong> <time class="svelte-1xkpg8l"> </time></header> <div class="reply__text svelte-1xkpg8l"> </div></article></div>`);
const $$css$9 = {
  hash: "svelte-1xkpg8l",
  code: ".reply.svelte-1xkpg8l{gap:var(--space-s);flex-direction:row;align-items:start;display:flex}.reply__content.svelte-1xkpg8l{padding:var(--space-xs);background-color:var(--color-neutral-100);border-radius:var(--border-radius)}.reply__content.svelte-1xkpg8l header:where(.svelte-1xkpg8l){gap:var(--space-xs);margin-bottom:var(--space-2xs);justify-content:flex-start;align-items:flex-start;display:flex}.reply__content.svelte-1xkpg8l header:where(.svelte-1xkpg8l) time:where(.svelte-1xkpg8l){font-size:var(--font-size-8);color:var(--color-neutral-300)}@media (prefers-color-scheme:dark){.reply__content.svelte-1xkpg8l{background-color:var(--color-neutral-200)}}.reply__text.svelte-1xkpg8l{white-space:pre-line}"
};
...
var root_4$1 = /* @__PURE__ */ template(`<ul class="comment__replies svelte-p9njwd"></ul>`);
var root_7 = /* @__PURE__ */ template(`<div class="buttons svelte-p9njwd"><!> <!></div>`);
var root$8 = /* @__PURE__ */ template(`<details><summary class="comment__header svelte-p9njwd"><!> <div class="comment__content svelte-p9njwd"><header class="svelte-p9njwd"><strong> </strong> <time class="svelte-p9njwd"> </time></header> <div class="comment__text svelte-p9njwd"> </div></div> <!></summary> <!> <footer class="svelte-p9njwd"><!></footer></details>`);
const $$css$8 = {
  hash: "svelte-p9njwd",
  code: '.comment.svelte-p9njwd{--_avatar-size:var(--loop-avatar-size);--loop-marker-background:var(--color-neutral-200);--loop-marker-color:var(--color-neutral-800);--marker-size:var(--_avatar-size);position:relative}.comment.svelte-p9njwd>:where(.svelte-p9njwd){z-index:1;position:relative}.comment.svelte-p9njwd:after{content:"";left:calc(var(--space-s) + var(--_avatar-size)/2);background-color:var(--color-neutral-100);z-index:0;width:.1rem;height:calc(100% - 4rem);position:absolute;top:1.5rem}.comment.svelte-p9njwd:not([open]):after{height:calc(100% - 2.75rem)}.comment__header.svelte-p9njwd{font-size:var(--font-size-7);padding:var(--space-s)var(--space-s);align-items:flex-start;gap:var(--space-s);cursor:pointer;display:flex}.comment__header.svelte-p9njwd .comment__replies-count{bottom:0;left:var(--space-s);min-width:var(--_avatar-size);position:absolute}.comment__header.svelte-p9njwd header:where(.svelte-p9njwd){gap:var(--space-xs);margin-bottom:var(--space-2xs);justify-content:flex-start;align-items:flex-start;display:flex}.comment__header.svelte-p9njwd header:where(.svelte-p9njwd) time:where(.svelte-p9njwd){font-size:var(--font-size-8);color:var(--color-neutral-300)}.comment__header.svelte-p9njwd .comment__content:where(.svelte-p9njwd){padding:var(--space-xs);background-color:var(--color-neutral-100);border-radius:var(--border-radius);flex:1}@media (prefers-color-scheme:dark){.comment__header.svelte-p9njwd .comment__content:where(.svelte-p9njwd){background-color:var(--color-neutral-200)}}.comment__header.svelte-p9njwd .comment__text:where(.svelte-p9njwd){white-space:pre-line}.comment__replies.svelte-p9njwd{padding:0 var(--space-s);gap:var(--space-s);flex-direction:column;margin:0;list-style:none;display:flex}footer.svelte-p9njwd{gap:var(--space-s);padding:var(--space-s)var(--space-s);flex-direction:column;display:flex}footer.svelte-p9njwd .buttons:where(.svelte-p9njwd){gap:var(--space-xs);align-items:flex-end;display:flex}.is-hidden.svelte-p9njwd{display:none}'
};
function Comment$1($$anchor, $$props) {
  ...
  template_effect(
    ($0, $1, $2) => {
      ...
      classes = set_class(details, 1, `comment comment--${comment2().status ?? ""}`, "svelte-p9njwd", classes, $0);
...
var root$7 = /* @__PURE__ */ ns_template(`<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-267e7"><path d="M2.5 12.5C2.5 7.78595 2.5 5.42893 3.96447 3.96447C5.42893 2.5 7.78595 2.5 12.5 2.5C17.214 2.5 19.5711 2.5 21.0355 3.96447C22.5 5.42893 22.5 7.78595 22.5 12.5C22.5 17.214 22.5 19.5711 21.0355 21.0355C19.5711 22.5 17.214 22.5 12.5 22.5C7.78595 22.5 5.42893 22.5 3.96447 21.0355C2.5 19.5711 2.5 17.214 2.5 12.5Z" stroke="currentColor" stroke-width="1.5"></path><path d="M9 9.5L12 12.5L9 15.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M13 9.5L16 12.5L13 15.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>`);
const $$css$7 = {
  hash: "svelte-267e7",
  code: "svg.svelte-267e7{width:var(--size,1em);height:var(--size,1em)}"
};
function IconSidebarClose($$anchor) {
  append_styles($$anchor, $$css$7);
  var svg = root$7();
  append($$anchor, svg);
}
create_custom_element(IconSidebarClose, {}, [], [], true);
var root$6 = /* @__PURE__ */ ns_template(`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-267e7"><path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="currentColor" stroke-width="1.5"></path><path d="M15.5 9L12.5 12L15.5 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M11.5 9L8.5 12L11.5 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>`);
const $$css$6 = {
  hash: "svelte-267e7",
  code: "svg.svelte-267e7{width:var(--size,1em);height:var(--size,1em)}"
};
function IconSidebarOpen($$anchor) {
  append_styles($$anchor, $$css$6);
  var svg = root$6();
  append($$anchor, svg);
}
create_custom_element(IconSidebarOpen, {}, [], [], true);
var root$5 = /* @__PURE__ */ ns_template(`<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-267e7"><path d="M5.44067 14.4885C6.54524 14.4885 7.44067 13.5931 7.44067 12.4885C7.44067 11.384 6.54524 10.4885 5.44067 10.4885C4.3361 10.4885 3.44067 11.384 3.44067 12.4885C3.44067 13.5931 4.3361 14.4885 5.44067 14.4885Z" stroke="currentColor" stroke-width="1.5"></path><path d="M12.4407 14.4885C13.5452 14.4885 14.4407 13.5931 14.4407 12.4885C14.4407 11.384 13.5452 10.4885 12.4407 10.4885C11.3361 10.4885 10.4407 11.384 10.4407 12.4885C10.4407 13.5931 11.3361 14.4885 12.4407 14.4885Z" stroke="currentColor" stroke-width="1.5"></path><path d="M19.4407 14.4885C20.5452 14.4885 21.4407 13.5931 21.4407 12.4885C21.4407 11.384 20.5452 10.4885 19.4407 10.4885C18.3361 10.4885 17.4407 11.384 17.4407 12.4885C17.4407 13.5931 18.3361 14.4885 19.4407 14.4885Z" stroke="currentColor" stroke-width="1.5"></path></svg>`);
const $$css$5 = {
  hash: "svelte-267e7",
  code: "svg.svelte-267e7{width:var(--size,1em);height:var(--size,1em)}"
};
...
var root_3$1 = /* @__PURE__ */ template(`<span class="filter-dot filter-dot--open svelte-18q028m" slot="icon"></span>`);
var root_5 = /* @__PURE__ */ template(`<span class="filter-dot filter-dot--resolved svelte-18q028m" slot="icon"></span>`);
var root$4 = /* @__PURE__ */ template(`<div class="context-menu-container svelte-18q028m"><div class="context-menu-trigger svelte-18q028m"><!></div> <div class="context-menu svelte-18q028m" popover="auto" role="menu" aria-labelledby="context-menu-trigger"><div class="menu-section svelte-18q028m"><div class="menu-section-title svelte-18q028m"> </div> <div class="filter-options svelte-18q028m"><!> <!></div></div></div></div>`);
const $$css$4 = {
  hash: "svelte-18q028m",
  code: ".context-menu-container.svelte-18q028m{bottom:var(--space-s);right:var(--space-s);z-index:10;position:absolute}.context-menu-trigger.svelte-18q028m{--button-size:2.5rem;width:var(--button-size);height:var(--button-size);border-radius:var(--border-radius-rounded);justify-content:center;align-items:center;display:flex}.context-menu.svelte-18q028m{background:var(--color-base-background);border-radius:var(--border-radius);box-shadow:var(--shadow-m);padding:var(--space-xs);border:0;min-width:12rem;margin:0;position:fixed}.context-menu.svelte-18q028m::backdrop{background:0 0}.menu-section.svelte-18q028m{gap:var(--space-2xs);flex-direction:column;display:flex}.menu-section-title.svelte-18q028m{font-size:var(--font-size-8);font-weight:var(--font-weight-medium);color:var(--color-neutral-500);margin-bottom:var(--space-2xs);text-transform:uppercase;letter-spacing:.05em;padding:0}.filter-options.svelte-18q028m{flex-direction:column;gap:1px;display:flex}.filter-dot.svelte-18q028m{width:.5em;height:.5em;margin-right:var(--space-2xs);border-radius:50%;display:inline-block}.filter-dot--open.svelte-18q028m{background:var(--color-accent)}.filter-dot--resolved.svelte-18q028m{background:var(--color-neutral-400)}"
};
...
var root_2$1 = /* @__PURE__ */ template(`<svelte-css-wrapper style="display: contents"><!></svelte-css-wrapper>`, 1);
var root_3 = /* @__PURE__ */ template(`<svelte-css-wrapper style="display: contents"><!></svelte-css-wrapper>`, 1);
var root_4 = /* @__PURE__ */ template(`<li class="no-threads svelte-oek6up"><p> </p></li>`);
var root_6 = /* @__PURE__ */ template(`<li class="no-threads svelte-oek6up"><p> </p></li>`);
var root_8 = /* @__PURE__ */ template(`<li class="svelte-oek6up"><!></li>`);
var root$3 = /* @__PURE__ */ template(`<div><header class="glass-effect svelte-oek6up"><!></header> <ul class="threads svelte-oek6up" data-lenis-prevent=""><!></ul> <!></div>`);
const $$css$3 = {
  hash: "svelte-oek6up",
  code: ".panel.svelte-oek6up{--_panel-width:var(--loop-panel-width);right:var(--space-xs);top:var(--space-xs);transform:translateX(calc(100% + var(--space-xs)));width:var(--_panel-width);height:calc(100svh - var(--space-xs)*2);color:var(--color-base);border-radius:var(--border-radius);transition:var(--transition-transform);z-index:var(--z-loop-panel);cursor:auto;border-top-left-radius:0;flex-direction:column;justify-content:flex-start;align-items:flex-start;display:flex;position:fixed}@media screen and (max-width:600px){.panel.svelte-oek6up{--loop-panel-width:85svw}}.panel.open.svelte-oek6up{box-shadow:var(--shadow-s);transform:translate(0)}.panel.open.svelte-oek6up header:where(.svelte-oek6up){transform:translate(calc(1px - 100%))}.panel.svelte-oek6up header:where(.svelte-oek6up){border-top-left-radius:var(--border-radius-rounded);border-bottom-left-radius:var(--border-radius-rounded);gap:var(--space-xs);border-top-right-radius:0;border-bottom-right-radius:0;flex-direction:column;display:flex;position:absolute;transform:translate(-95%)}.panel.svelte-oek6up header:where(.svelte-oek6up):hover,.panel.svelte-oek6up header:where(.svelte-oek6up):focus-visible{transform:translate(calc(1px - 100%))}.threads.svelte-oek6up{overscroll-behavior:contain;padding:0 0 var(--space-s)0;box-sizing:border-box;background-color:var(--loop-glass-effect-background);width:100%;-webkit-backdrop-filter:var(--loop-glass-effect-backdrop);backdrop-filter:var(--loop-glass-effect-backdrop);z-index:2;border-radius:var(--border-radius);scrollbar-width:thin;scrollbar-gutter:stable;border-top-left-radius:0;flex-direction:column;flex:100%;margin:0;list-style:none;display:flex;overflow-y:auto}.threads.svelte-oek6up li:where(.svelte-oek6up)+li:where(.svelte-oek6up){margin-top:var(--space-s)}.threads.svelte-oek6up .no-threads:where(.svelte-oek6up){text-align:center;padding:var(--space-s)var(--space-l);font-size:var(--font-size-6);color:var(--color-neutral-300);margin-block:auto}"
};
function Panel($$anchor, $$props) {
    ...
    children: ($$anchor2, $$slotProps) => {
      ...
      var node_1 = first_child(fragment);
      {
        var consequent = ($$anchor3) => {
          ...
          {
            css_props(node_2, () => ({ "--size": "1.5em" }));
            IconSidebarClose(node_2.lastChild);
            reset$1(node_2);
          }
        ...
        var alternate = ($$anchor3) => {
          ...
          {
            css_props(node_3, () => ({ "--size": "1.5em" }));
            IconSidebarOpen(node_3.lastChild);
            reset$1(node_3);
          }
          append($$anchor3, fragment_2);
        };
        if_block(node_1, ($$render) => {
          if (panel.open) $$render(consequent);
          else $$render(alternate, false);
        });
      }
  ...
  var node_4 = child(ul);
  {
    ...
    var alternate_1 = ($$anchor2, $$elseif) => {
      {
        ...
        var alternate_2 = ($$anchor3) => {
          ...
          each(node_5, 17, () => get(filteredComments), (comment2) => comment2.id, ($$anchor4, comment2) => {
            var li_2 = root_8();
        ...
        if_block(
          $$anchor2,
          ($$render) => {
            if (get(filteredComments).length === 0 && panel.showResolvedOnly) $$render(consequent_2);
    ...
    if_block(node_4, ($$render) => {
      if (get(filteredComments).length === 0) $$render(consequent_1);
      else $$render(alternate_1, false);
    });
  }
  reset$1(ul);
  ...
  ContextMenu(node_7, {});
  reset$1(div);
  template_effect(($0) => classes = set_class(div, 1, "panel svelte-oek6up", null, classes, $0), [() => ({ open: panel.open })]);
  append($$anchor, div);
  return pop({
    get scrollIntoView() {
      return scrollIntoView();
...
const $$css$2 = {
  hash: "svelte-14xa50s",
  code: "dialog.svelte-14xa50s{--loop-textarea-font-size:var(--loop-textarea-font-size-large);top:var(--top);left:var(--left);max-width:var(--loop-comment-dialog-max-width);border-radius:var(--border-radius);visibility:hidden;width:100%;max-height:none;box-shadow:var(--shadow-s);border:0;margin:0;padding:0;position:absolute;overflow:hidden}dialog.is-visible.svelte-14xa50s{visibility:visible}dialog.svelte-14xa50s::backdrop{background-color:var(--loop-dialog-background)}"
};
function CommentDialog($$anchor, $$props) {
  ...
  template_effect(
    ($0) => {
      ...
      classes = set_class(dialog, 1, "svelte-14xa50s", null, classes, $0);
    },
...
var root_1 = /* @__PURE__ */ template(`<h2 class="svelte-1yexn8i"> </h2> <p class="welcome-text svelte-1yexn8i"> </p>`, 1);
var root_2 = /* @__PURE__ */ template(`<div><div class="input"><input type="text" required class="svelte-1yexn8i"></div></div>`);
var root$1 = /* @__PURE__ */ template(`<dialog class="svelte-1yexn8i"><form class="svelte-1yexn8i"><!> <!> <footer class="svelte-1yexn8i"><!> <!></footer></form></dialog>`);
const $$css$1 = {
  hash: "svelte-1yexn8i",
  code: "dialog.svelte-1yexn8i{background-color:var(--color-base-background);border:1px solid var(--color-neutral-100);border-radius:var(--border-radius);box-shadow:var(--shadow-m);width:100%;max-width:var(--loop-welcome-dialog-max-width);padding:0}dialog.svelte-1yexn8i::backdrop{background:var(--backdrop-overlay);-webkit-backdrop-filter:var(--backdrop-blur);backdrop-filter:var(--backdrop-blur)}form.svelte-1yexn8i{padding:var(--space-l)}h2.svelte-1yexn8i{margin:0 0 var(--space-s)0;font-size:var(--font-size-4);color:var(--color-base);font-weight:var(--font-weight-bold)}.welcome-text.svelte-1yexn8i{margin:0 0 var(--space-m)0;font-size:var(--font-size-6);color:var(--color-neutral-600);line-height:var(--line-height)}.name-section.svelte-1yexn8i{margin-bottom:var(--space-l)}.name-section.no-welcome.svelte-1yexn8i{border-top:none;padding-top:0}input.svelte-1yexn8i{border:1px solid var(--color-neutral-300);border-radius:var(--border-radius-s);width:100%;padding:var(--space-xs);box-sizing:border-box;font-family:var(--font-family);font-size:var(--font-size-6);color:var(--color-base);background:var(--color-base-background)}input.svelte-1yexn8i:focus-visible{outline-color:var(--outline-color);outline-offset:var(--outline-offset)}footer.svelte-1yexn8i{gap:var(--space-xs);display:flex}footer.svelte-1yexn8i button{flex:1}"
};
function WelcomeDialog($$anchor, $$props) {
  ...
  var node_1 = sibling(node, 2);
  {
    var consequent_1 = ($$anchor2) => {
      ...
      template_effect(
        ($0, $1) => {
          classes = set_class(div, 1, "name-section svelte-1yexn8i", null, classes, $0);
...
const $$css = {
  hash: "svelte-1qwevar",
  code: '.glass-effect{-webkit-backdrop-filter:blur(16px)saturate(1.8);backdrop-filter:blur(16px)saturate(1.8);background:linear-gradient(135deg,#ffffff1f 0%,#ffffff0d 50%,#ffffff14 100%);transition:all .3s cubic-bezier(.4,0,.2,1);position:relative;overflow:hidden;box-shadow:0 8px 32px #0000001f,0 2px 8px #00000014,inset 0 1px #ffffff26,inset 0 -1px #0000000d}.glass-effect:hover{-webkit-backdrop-filter:blur(20px)saturate(2);backdrop-filter:blur(20px)saturate(2);background:linear-gradient(135deg,#ffffff2e 0%,#ffffff14 50%,#ffffff1f 100%);box-shadow:0 12px 40px #00000026,0 4px 12px #0000001a,inset 0 1px #fff3,inset 0 -1px #0000000d}.glass-effect::before{content:"";pointer-events:none;border-radius:inherit;background:linear-gradient(90deg,#0000,#ffffff14,#0000) 0 0/200% 100%;animation:8s ease-in-out infinite svelte-1qwevar-glassShimmer;position:absolute;inset:0}.glass-effect-small{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);background:linear-gradient(135deg,#ffffff26 0%,#ffffff0d 100%);transition:all .2s;box-shadow:0 4px 16px #0000001a,inset 0 1px #fff3}.glass-effect-small:hover{background:linear-gradient(135deg,#fff3 0%,#ffffff14 100%);transform:scale(1.05)}@keyframes svelte-1qwevar-glassShimmer{0%{background-position:-200% 0}to{background-position:200% 0}}'
};
